...
#define dotPinvJac_fun_SZ_W 227
...
#define dotPinvJacPos_fun_SZ_W 58
...
#define jac_fun_SZ_W 16
extern "C" int regr_classic_fun(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem);
extern "C" int regr_classic_fun_alloc_mem(void);
extern "C" int regr_classic_fun_init_mem(int mem);
extern "C" void regr_classic_fun_free_mem(int mem);
extern "C" int regr_classic_fun_checkout(void);
extern "C" void regr_classic_fun_release(int mem);
extern "C" void regr_classic_fun_incref(void);
extern "C" void regr_classic_fun_decref(void);
extern "C" casadi_int regr_classic_fun_n_in(void);
extern "C" casadi_int regr_classic_fun_n_out(void);
extern "C" casadi_real regr_classic_fun_default_in(casadi_int i);
extern "C" const char* regr_classic_fun_name_in(casadi_int i);
extern "C" const char* regr_classic_fun_name_out(casadi_int i);
extern "C" const casadi_int* regr_classic_fun_sparsity_in(casadi_int i);
extern "C" const casadi_int* regr_classic_fun_sparsity_out(casadi_int i);
extern "C" int regr_classic_fun_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w);
#define regr_classic_fun_SZ_ARG 4
#define regr_classic_fun_SZ_RES 1
#define regr_classic_fun_SZ_IW 0
#define regr_classic_fun_SZ_W 112
