...
namespace regrob{
    ...
    class RegBasic {
        ...
        protected:
            ...
            std::tuple<casadi::SXVector,casadi::SXVector> DHJac(const casadi::SXVector& T0i_vec, const std::string& jtsType,frame& base_frame,frame& ee_frame);
            ...
            casadi::SX SXregressor(const Eigen::MatrixXd& DH_table,const std::string& jType, frame& base_frame,frame& ee_frame);
            casadi::Function DHReg_fun(const casadi::SX& SX_Yr);
            casadi::Function DHJac_fun(const Eigen::MatrixXd& DH_table, const std::string& jtsType, frame& base_frame,frame& ee_frame,const double tol_);
            casadi::Function DHKin_fun(const Eigen::MatrixXd& DH_table, const std::string& jtsType, frame& base_frame,frame& ee_frame);
