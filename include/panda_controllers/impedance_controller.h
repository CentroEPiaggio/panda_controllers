...
//                                    CLASS CONTROLLER                                      //
//==========================================================================================//
class ImpedanceController : public controller_interface::MultiInterfaceController
 	...
 	private:
		...
		void desiredImpedanceCallback(const panda_controllers::DesiredImpedance::ConstPtr& msg);
